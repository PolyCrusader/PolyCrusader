...
function TierList() {
        ...
        for (let y = 0; y < 4; y++) {
            ...
            for (let i = 0; i < data[y].Actions.length; i++) {
                ...
                .then(image => {
                    ...
                    let card = new Card("card " + y+'-'+i, image.default, "Action" + (y + 1), i, data[y].Actions[i].Description, data[y].Name);
    ...
    function handleSubmit() {
        if (Action1.length === 0 && Action2.length === 0 && Action3.length === 0 && Action4.length===0) { setSubmit(true); }
    }
    ...
    return (
        <div>
            ...
            style={{backgroundColor:(Action1.length === 0 && Action2.length === 0 && Action3.length === 0 && Action4.length===0) ? 'green' : 'red'}}
            >Submit</button>
